...
//------------------------------------------------------------------------------------------------------------+
        ...
        function lgsl_type_list()
        {
                ...
                "callofduty4x18"        => "Call Of Duty 4 X18",
...
//------------------------------------------------------------------------------------------------------------+
        function lgsl_query_35(&$server, &$lgsl_need, &$lgsl_fp)
        {
                ...
                curl_close($ch);
                                //Parser
                preg_match_all("(<tr><td style=\"vertical-align:top;\">(.*)<        r>)siU", $result, $matches);
                foreach ( $matches[1] as $servers ) 
                {
                        if (preg_match("/$ip:$port/",$servers))
                        {
                                ...
                                //players
                                preg_match_all("(</div><        d><td style=\"vertical-align\:top\;\"><span style=\"color\:#......\;\">(.*)<        d><td style=\"vertical-align\:top\;\">)siU", $servers, $playerscnt);
                                ...
                                //map
                                preg_match_all("(<        d><td style=\"vertical-align:top;\">(.*)<        d><td style=\"vertical-align:top;\"><span style=\"color)siU", $servers, $mapname);
                                ...
                                $mapstring = str_replace('<        d><td style="vertical-align:top;">', "", $mapstring);
                                ...
                                //players list
                                preg_match_all("(<td style=\"vertical-align:top;font-size:0.9em;\"><span style=\"color:#888888;\">(.*)<        d>)siU", $servers, $playerslist);
                                $players_array[0] = "";
        ...
        function lgsl_query_36(&$server, &$lgsl_need, &$lgsl_fp)
        {
                ...
                if ( !empty($data) )
                {
                        ...
                        if (preg_match_all("(terrain:(.*)INFO)siU", $info_row, $info))
                        {
                                ...
                                {
                                        $value = trim($value);
                                        $remote->remote_writefile($home_info['home_path'].'        errain.txt',$value);
                                        $server['s']['map'] = $value;
                                }
                        }
                        ...
                        if(empty($server['s']['name']))
                        {
                                ...
                                $remote->remote_readfile($home_info['home_path'].'        errain.txt',$value2);
                                $value2 = trim($value2);
                                $server['s']['map'] = $value2;
